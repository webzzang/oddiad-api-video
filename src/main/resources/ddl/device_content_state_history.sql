...
-- ----------------------------
-- Table structure for device_content_state_history
-- ----------------------------
DROP TABLE IF EXISTS `device_content_state_history`;
CREATE TABLE `device_content_state_history`  (
...
) ENGINE = InnoDB AUTO_INCREMENT = 920 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = '컨텐츠(재생) 상태 히스토리' ROW_FORMAT = Dynamic;
